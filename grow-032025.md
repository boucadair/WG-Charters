...
The GROW working group will collaborate with other working groups, primarily IDR WG,
that are developing solutions for the global IP routing system. When solicited, the WG
will review the solutions being developed for the global routing system by these other
working groups and provide inputs related to operational implications. The WG will also
