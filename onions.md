...
| July 2027                 |Publish document for Service-layer APIs based on YANG service models to interface with OSS/BSS as RFC. | Document detailing the Service-layer APIs based on YANG service models to interface with OSS/BSS | PS |
| July 2027                 |Publish document for reusable service framework for YANG data models as RFC. | Document detailing the framework for reusable service YANG data models | PS |
| September 2027            |Publish document updating the YANG network data models for L3NM and L2NM as RFC. | Updated documents for L2NM and L3NM YANG data models based on operational feedback and deployment experiences, with attention to operational state data and identified gaps. | PS |
| September 2027            |Publish document updating the YANG service data models for L3SM and L2SM as RFC. | Updated documents for L3SM and L3SM YANG data models based on operational feedback and deployment experiences, with attention to operational state data and identified gaps. | PS |
