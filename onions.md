...
Operators commonly expose service abstractions through APIs built from YANG data models; the ONIONS WG will provide guidance and requirements for making these YANG-based service APIs operationally consistent, automatable, and consumable by external systems through in a predictable and interoperable manner across systems and vendors, including upper-layer OSS/BSS. Additionally, the WG will assess the applicability of these abstractions to accommodate specific operational use cases and deployments, ensuring relevance to real-world environments.
