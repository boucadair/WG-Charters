...
Operators commonly expose service abstractions through APIs built from YANG service models; the ONIONS WG will provide guidance and requirements for making these YANG-based service APIs operationally consistent, automatable, and consumable across systems and vendors. Additionally, the WG will assess the applicability of these abstractions to accommodate specific operational use cases and deployments, ensuring relevance to real-world environments.
